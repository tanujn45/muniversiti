...
<body>
    ...
    <section id="numbers">
        <div class="container-fluid">
            <div class="row section text-center justify-content-center">
    ...
    <section id="vmion">
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-lg-5 vertical-center section">
                    <div class="mx-1" data-aos="fade-up">
                ...
                <div class="col-lg-7 vertical-center">
                    <div data-aos="fade-in" data-aos-delay="800" class="mx-1">
                        <img src="img/vmion.jpg" class="img-fluid" alt="">
                    </div>
                </div>
            </div>
        </div>
